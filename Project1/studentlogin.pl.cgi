...
if($l==0){
	...
	if($found==1) {
	        my $c = CGI::Cookie->new(-name    =>  "InstraSchedulestudentloginfo=$username",
                            );
		$c->bake;
...
<body id = "type-a">
	...
	<div id = "content">
		...
		<FORM ACTION="./studentlogin.pl.cgi" METHOD="POST">
...
<body id = "type-a">
	...
	<div id = "content">
		...
		<input type="submit" name="studentReset" value="Reset Password">
		</FORM>
		</div></div></div>
	</body></html>
EndOfPrinting
